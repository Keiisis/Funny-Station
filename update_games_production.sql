...
-- Ce script fait pointer les jeux directement vers Supabase Storage, qui gère 
...
SET 
  ...
  assets_bucket_path = 'https://dotphlrugmxxavmeactm.supabase.co/storage/v1/object/public/game-assets/games/street-fighter-alpha-2-gold'
...
SET 
  ...
  assets_bucket_path = 'https://dotphlrugmxxavmeactm.supabase.co/storage/v1/object/public/game-assets/games/assassins-creed-bloodlines'
...
SET 
  ...
  assets_bucket_path = 'https://dotphlrugmxxavmeactm.supabase.co/storage/v1/object/public/game-assets/games/god-of-war-ghost-of-sparta'
...
SET 
  ...
  assets_bucket_path = 'https://dotphlrugmxxavmeactm.supabase.co/storage/v1/object/public/game-assets/games/gta-vice-city-stories'
